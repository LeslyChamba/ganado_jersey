...
try:
    ...
    # En el dataset 62/67 vacas tienen SAM vertical → ratio < 1
    # Normalizamos en entrenamiento Y producción: max(r, 1/r)
    ...
    try:
        ...
        if MASS_MODEL.exists():
            ...
            feat = np.array([[
                ratio_lh_norm, m["htor_norm"], m["cad_norm"],   # ← ratio normalizado
